...
class FeatureHasher(River2SKLTransformer):
...
class OneHotEncoder(River2SKLTransformer):
...
class AdaptiveStandardScaler(River2SKLTransformer):
...
class Binarizer(River2SKLTransformer):
...
class StandardScaler(River2SKLTransformer):
