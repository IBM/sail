"""
Code from: https://github.com/akusok/scikit-elm/tree/master
...
class ELMClassifier(ScikitELM, ClassifierMixin):
    ...
    def partial_fit(self, X, y=None, forget=False, update_classes=False, compute_output_weights=True, classes=None) -> ELMClassifier:
