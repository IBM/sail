# Code mostly from https://github.com/scikit-multiflow/scikit-multiflow/blob/master/src/skmultiflow/meta/batch_incremental.py
import copy as cp
...
class MetaIncrementalClassifier(BaseEstimator):
    ...
    def __init__(self, base_estimator=DecisionTreeClassifier(), window_size=100, n_estimators=10):
